...
PM25 _$PM25FromJson(Map<String, dynamic> json) {
  return PM25(aqi: json['aqi'] as String, quality: json['quality'] as String, pm25: json['pm25'] as String);
}

Map<String, dynamic> _$PM25ToJson(PM25 instance) =>
    <String, dynamic>{'aqi': instance.aqi, 'quality': instance.quality, 'pm25': instance.pm25};
